...
/*   Updated: 2024/04/04 12:10:50 by jbolanho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	close_hook(void *param)
{
	...
	free_sprite(data, data->player_r1_data);
	free_sprite(data, data->player_l1_data);
	free_sprite(data, data->player_r2_data);
	free_sprite(data, data->player_l2_data);
	free_sprite(data, data->player_cr1_data);
	free_sprite(data, data->player_cl1_data);
	free_sprite(data, data->player_cr2_data);
	free_sprite(data, data->player_cl2_data);
	...
	free_sprite(data, data->enemy_data);
	free_sprite(data, data->counter_data);
	mlx_delete_image(data->mlx, data->txt_steps);
